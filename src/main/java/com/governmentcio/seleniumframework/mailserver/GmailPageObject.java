...
package com.governmentcio.seleniumframework.mailserver;
...
/**
 * This class is the Page Object for interacting with the Google Mail service.
 *
...
public class GmailPageObject extends AbstractPageObject {
	 ...
	 *           Throws IOException.
	 */
	public GmailPageObject(final WebDriver driver) throws IOException {
		super(driver);
